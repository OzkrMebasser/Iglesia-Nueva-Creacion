      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">{t('home.worship.title')}</h2>
            <p className="text-gray-600">{t('home.worship.description')}</p>
          </div>

          {/* Community */}
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">{t('home.community.title')}</h2>
            <p className="text-gray-600">{t('home.community.description')}</p>
          </div>

          {/* Mission */}
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">{t('home.mission.title')}</h2>
